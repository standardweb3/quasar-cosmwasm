...
pub fn get_utilization_rate(cash: &Uint128, borrows: &Uint128, reserves: &Uint128) -> u128 {
...
pub fn get_supply_rate(cash: &Uint128, borrows: &Uint128, reserves: &Uint128, reserve_factor: &Uint128) -> u128 {
